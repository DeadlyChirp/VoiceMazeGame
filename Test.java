...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        String com = "/usr/bin/java -Xmx2024m -jar ./LIUM_SpkDiarization-4.2.jar --fInputMask=./Records/Audio.wav --sOutputMask=./Analysis/Audio.seg --fInputDesc=audio16Khz2sphinx:sphinx,1:1:0:0:0:0,18,0:0:0:0 --doCEClustering Audio --help" ; 
